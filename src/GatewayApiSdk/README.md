...
additionalProperties:
  packageGuid: '{F39958E6-62F6-4B98-B47D-09F6773EFD51}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            IFetchAdminDataCustodianNetworksApiResponse apiResponse = await api.FetchAdminDataCustodianNetworksAsync("todo");
