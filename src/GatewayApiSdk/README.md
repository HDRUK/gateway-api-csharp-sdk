...
inputSpec: storage/api-docs/api-docs.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{2B31561F-DA7B-4E61-AF59-A76DF7DC46FF}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IAdminDataCustodianNetworksApi>();
            ICall805e0e12862cf992698405bf5795b042ApiResponse apiResponse = await api.Call805e0e12862cf992698405bf5795b042Async("todo");
