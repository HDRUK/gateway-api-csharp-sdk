...
additionalProperties:
  packageGuid: '{D289156F-BBE0-436F-BB37-E10D6E263302}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IApplicationApi>();
            ICreateApplicationsApiResponse apiResponse = await api.CreateApplicationsAsync("todo");
            CreateApplications200Response? model = apiResponse.Ok();
        }
