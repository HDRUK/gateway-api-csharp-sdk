...
namespace GatewayApiSdk.Model
{
    ...
    /// </summary>
    public partial class CreateDatasetsRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDatasetsRequest" /> class.
        /// </summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="CreateDatasetsRequest" />
    /// </summary>
    public partial class CreateDatasetsRequestJsonConverter : JsonConverter<CreateDatasetsRequest>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDatasetsRequestJsonConverter" /> class.
        /// </summary>
        public CreateDatasetsRequestJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="CreateDatasetsRequest" />
        /// </summary>
        ...
        public override CreateDatasetsRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (teamId.IsSet && teamId.Value == null)
                throw new ArgumentNullException(nameof(teamId), "Property is not nullable for class CreateDatasetsRequest.");

            if (userId.IsSet && userId.Value == null)
                throw new ArgumentNullException(nameof(userId), "Property is not nullable for class CreateDatasetsRequest.");
        ...
        /// <summary>
        /// Serializes a <see cref="CreateDatasetsRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createDatasetsRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CreateDatasetsRequest createDatasetsRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, createDatasetsRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CreateDatasetsRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createDatasetsRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CreateDatasetsRequest createDatasetsRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (createDatasetsRequest.MetadataOption.IsSet && createDatasetsRequest.Metadata == null)
                throw new ArgumentNullException(nameof(createDatasetsRequest.Metadata), "Property is required for class CreateDatasetsRequest.");

            if (createDatasetsRequest.TeamIdOption.IsSet)
                writer.WriteNumber("team_id", createDatasetsRequest.TeamIdOption.Value!.Value);

            if (createDatasetsRequest.UserIdOption.IsSet)
                writer.WriteNumber("user_id", createDatasetsRequest.UserIdOption.Value!.Value);
            ...
            if (createDatasetsRequest.MetadataOption.IsSet)
            {
                writer.WritePropertyName("metadata");
                JsonSerializer.Serialize(writer, createDatasetsRequest.Metadata, jsonSerializerOptions);
            }
        }
    }
}
