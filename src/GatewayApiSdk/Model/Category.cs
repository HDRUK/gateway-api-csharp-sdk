...
namespace GatewayApiSdk.Model
{
    ...
    public partial class Category : IValidatableObject
    {
        ...
        [JsonConstructor]
        public Category(Option<int?> id = default, Option<string?> name = default, Option<bool?> enabled = default, Option<DateTime?> createdAt = default, Option<DateTime?> updatedAt = default)
        {
            IdOption = id;
            NameOption = name;
    ...
    public partial class CategoryJsonConverter : JsonConverter<Category>
    {
        ...
        public override Category Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (enabled.IsSet && enabled.Value == null)
                throw new ArgumentNullException(nameof(enabled), "Property is not nullable for class Category.");

            if (createdAt.IsSet && createdAt.Value == null)
                throw new ArgumentNullException(nameof(createdAt), "Property is not nullable for class Category.");

            if (updatedAt.IsSet && updatedAt.Value == null)
                throw new ArgumentNullException(nameof(updatedAt), "Property is not nullable for class Category.");

            return new Category(id, name, enabled, createdAt, updatedAt);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, Category category, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (category.EnabledOption.IsSet)
                writer.WriteBoolean("enabled", category.EnabledOption.Value!.Value);

            if (category.CreatedAtOption.IsSet)
                writer.WriteString("created_at", category.CreatedAtOption.Value!.Value.ToString(CreatedAtFormat));

            if (category.UpdatedAtOption.IsSet)
                writer.WriteString("updated_at", category.UpdatedAtOption.Value!.Value.ToString(UpdatedAtFormat));
        }
    }
}
