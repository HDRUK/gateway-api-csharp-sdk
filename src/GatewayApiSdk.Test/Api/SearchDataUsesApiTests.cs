...
{
    /// <summary>
    ///  Class for testing SearchDataUsesApi
    /// </summary>
    public sealed class SearchDataUsesApiTests : ApiTestsBase
    {
        private readonly ISearchDataUsesApi _instance;

        public SearchDataUsesApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<ISearchDataUsesApi>();
        }
